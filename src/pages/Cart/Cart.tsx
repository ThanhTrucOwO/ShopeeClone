      ...
      <div className='container'>
        {extendedPurchases.length > 0 ? (
          <>
            ...
            <div className='sticky bottom-0 z-10 mt-8 flex flex-col sm:flex-row sm:items-center rounded-sm bg-white p-5 shadow border-gray-100'>
          ...
          <div className='text-center'>
            ...
            <div className='text-center mt-5'>
              <Link
                to={path.home}
                className='bg-orange px-10 py-2 rounded-sm hover:bg-orange/80 transition-all uppercase text-white'
              >
                Mua ngay
              </Link>
            </div>
